...
# -*- coding: utf-8 -*-
#
# structure-analyzer-featurizer documentation build configuration file, created by  # noqa: E501
...
try:
    fullversion = version("structure_analyzer_featurizer")
except Exception:
...
# abbreviations
ab_authors = "Sangjoon Lee, Anton Oliynyk, Emil Jaffal, Danila Shiryaev"
...
project = "Structure Analyzer/Featurizer (SAF)"
...
modindex_common_prefix = ["structure-analyzer-featurizer"]
...
html_context = {
    ...
    "github_repo": "structure-analyzer-featurizer",
    "github_version": "main",
...
basename = "structure-analyzer-featurizer".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "structure-analyzer-featurizer.tex",
        "structure-analyzer-featurizer Documentation",
        ab_authors,
        "manual",
    ),
]
