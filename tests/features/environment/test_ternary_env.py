...
def test_compute_binary_env_features_ThSb(URhIn_cif):
    actual = compute_features(URhIn_cif)
    expected = {
        "ENV_R_shortest_dist_count": np.int64(3),
        "ENV_M_shortest_dist_count": np.int64(6),
        "ENV_X_shortest_dist_count": np.int64(2),
        ...
        "ENV_R_second_by_first_shortest_dist": np.float64(1.000335232986926),
        "ENV_M_second_by_first_shortest_dist": np.float64(1.1294030404152762),
        "ENV_X_second_by_first_shortest_dist": np.float64(1.057471264367816),
        "ENV_R_avg_second_by_first_shortest_dist": np.float64(1.000335232986926),
        "ENV_M_avg_second_by_first_shortest_dist": np.float64(1.0648768357756606),
        "ENV_X_avg_second_by_first_shortest_dist": np.float64(1.057471264367816),
        "ENV_R_second_shortest_dist_count": np.int64(1),
        "ENV_M_second_shortest_dist_count": np.int64(3),
        "ENV_X_second_shortest_dist_count": np.int64(2),
