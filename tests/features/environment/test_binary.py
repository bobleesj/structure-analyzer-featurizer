...
def test_compute_binary_env_features_ThSb(ThSb_cif):
    ...
    expected = {
        "ENV_A_shortest_dist_count": np.int64(8),
        "ENV_B_shortest_dist_count": np.int64(8),
        ...
        "ENV_A_second_by_first_shortest_dist": np.float64(1.154561824729892),
        "ENV_B_second_by_first_shortest_dist": np.float64(1.154561824729892),
        "ENV_A_avg_second_by_first_shortest_dist": np.float64(1.154561824729892),
        "ENV_B_avg_second_by_first_shortest_dist": np.float64(1.154561824729892),
        "ENV_A_second_shortest_dist_count": np.int64(6),
        "ENV_B_second_shortest_dist_count": np.int64(6),
