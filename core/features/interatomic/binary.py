...
def compute_features(cif: Cif):
    ...
    distAB_by_A_and_B_combined = distAB / (A_CIF_rad + B_CIF_rad)
    ...
    min_heteroatomic_dist = helper.get_min_from_dists(heteroatomic_dists)
    min_homoatomic_dist = helper.get_min_from_dists(homoatomic_dists)
    ...
    shortest_homo_key = [k for k, v in min_bond_dists.items() if v == min_homoatomic_dist][0]
    shortest_homoatomic_dist_by_2_by_atom_size = (min_homoatomic_dist / 2) / rad_dict[shortest_homo_key]
    shortest_homoatomic_dist_by_2_by_refined_atom_sizes = (min_homoatomic_dist / 2) / refined_rad_dict[
        shortest_homo_key
    ]
    shortest_heteroatomic_dist_by_sum_of_atom_sizes = min_heteroatomic_dist / rad_dict["AB"]
    shortest_heteroatomic_dist_by_refined_atom_sizes = min_heteroatomic_dist / refined_rad_dict["AB"]
    ...
    data = {
        ...
        "INT_distAB_by2_byAsizebyBsize": distAB_by_A_and_B_combined,
        ...
        "INT_UNI_shortest_homoatomic_dist": min_homoatomic_dist,
        "INT_UNI_shortest_heteroatomic_dist": min_heteroatomic_dist,
        "INT_UNI_shortest_homoatomic_dist_by_2_by_atom_size": shortest_homoatomic_dist_by_2_by_atom_size,
        "INT_UNI_shortest_heteroatomic_dist_by_sum_of_atom_sizes": shortest_heteroatomic_dist_by_sum_of_atom_sizes,
        "INT_UNI_shortest_homoatomic_dist_by_2_by_refined_atom_size": shortest_homoatomic_dist_by_2_by_refined_atom_sizes,
        "INT_UNI_shortest_heteroatomic_dist_by_sum_of_refined_atom_sizes": shortest_heteroatomic_dist_by_refined_atom_sizes,
