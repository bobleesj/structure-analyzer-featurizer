...
def compute_ternary_env_features(cif: Cif):
    ...
    R_shortest_dist_count_within_tol = tol_results[R][
        "shortest_dist_count_within_tol"
    ]
    M_shortest_dist_count_within_tol = tol_results[M][
        "shortest_dist_count_within_tol"
    ]
    X_shortest_dist_count_within_tol = tol_results[X][
        "shortest_dist_count_within_tol"
    ]
    ...
    R_second_shortest_dist = best_site_data[R]["details"][
        "second_shortest_dist"
    ]
    M_second_shortest_dist = best_site_data[M]["details"][
        "second_shortest_dist"
    ]
    X_second_shortest_dist = best_site_data[X]["details"][
        "second_shortest_dist"
    ]

    # First shortest distance count
    R_shortest_dist_count = best_site_data[R]["details"]["counts"][
        R_shortest_dist
    ]
    M_shortest_dist_count = best_site_data[M]["details"]["counts"][
        M_shortest_dist
    ]
    X_shortest_dist_count = best_site_data[X]["details"]["counts"][
        X_shortest_dist
    ]
    ...
    results = {
        ...
        "ENV_R_second_by_first_shortest_dist": R_second_shortest_dist
        / R_shortest_dist,
        "ENV_M_second_by_first_shortest_dist": M_second_shortest_dist
        / M_shortest_dist,
        "ENV_X_second_by_first_shortest_dist": X_second_shortest_dist
        / X_shortest_dist,
