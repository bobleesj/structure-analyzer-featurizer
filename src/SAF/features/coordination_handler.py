...
from SAF.utils.element_parser import (
...
def get_CN_atom_count_data(cif: Cif):
    ...
    CN_metrices = get_CN_metrics_per_method(cif)
    ...
    if len(cif.unique_elements) == 2:
        ...
        CN_atom_count_data = compute_number_of_atoms_in_binary_CN(
            cif.connections, CN_metrices, A, B
        )

    if len(cif.unique_elements) == 3:
        R, M, X = get_ternary_RMX_elements(list(cif.unique_elements))
        CN_atom_count_data = compute_number_of_atoms_in_ternary_CN(
            cif.connections, CN_metrices, R, M, X
        )
    ...
    avg_CN_metrics = compute_global_averages_for_min_max_avg_metrics(
        min_max_avg_CN_metrices
    )
    avg_CN_atom_count = compute_global_averages_for_min_max_avg_metrics(
        min_max_avg_CN_count
    )
...
def get_CN_binary_features(cif: Cif):
    ...
    data = {
        "CN_AVG_coordination_number": avg_CN_metrics["avg"][
            "number_of_vertices"
        ],
        "CN_AVG_A_atom_count": avg_CN_atom_count["avg"]["A_count"],
        "CN_AVG_B_atom_count": avg_CN_atom_count["avg"]["B_count"],
        "CN_AVG_polyhedron_volume": avg_CN_metrics["avg"][
            "volume_of_polyhedron"
        ],
        "CN_AVG_central_atom_to_center_of_mass_dist": avg_CN_metrics["avg"][
        ...
        "CN_AVG_shortest_distance_to_face": avg_CN_metrics["avg"][
            "shortest_distance_to_face"
        ],
        "CN_AVG_shortest_distance_to_edge": avg_CN_metrics["avg"][
            "shortest_distance_to_edge"
        ],
        "CN_AVG_volume_of_inscribed_sphere": avg_CN_metrics["avg"][
            "volume_of_inscribed_sphere"
        ],
        "CN_AVG_packing_efficiency": avg_CN_metrics["avg"][
            "packing_efficiency"
        ],
        "CN_MIN_coordination_number": avg_CN_metrics["min"][
            "number_of_vertices"
        ],
        "CN_MIN_A_atom_count": avg_CN_atom_count["min"]["A_count"],
        "CN_MIN_B_atom_count": avg_CN_atom_count["min"]["B_count"],
        "CN_MIN_polyhedron_volume": avg_CN_metrics["min"][
            "volume_of_polyhedron"
        ],
        "CN_MIN_central_atom_to_center_of_mass_dist": avg_CN_metrics["min"][
            "distance_from_avg_point_to_center"
        ],
        "CN_MIN_number_of_edges": avg_CN_metrics["min"]["number_of_edges"],
        "CN_MIN_number_of_faces": avg_CN_metrics["min"]["number_of_faces"],
        "CN_MIN_shortest_distance_to_face": avg_CN_metrics["min"][
            "shortest_distance_to_face"
        ],
        "CN_MIN_shortest_distance_to_edge": avg_CN_metrics["min"][
            "shortest_distance_to_edge"
        ],
        "CN_MIN_volume_of_inscribed_sphere": avg_CN_metrics["min"][
            "volume_of_inscribed_sphere"
        ],
        "CN_MIN_packing_efficiency": avg_CN_metrics["min"][
            "packing_efficiency"
        ],
        "CN_MAX_coordination_number": avg_CN_metrics["min"][
            "number_of_vertices"
        ],
        "CN_MAX_A_atom_count": avg_CN_atom_count["max"]["A_count"],
        "CN_MAX_B_atom_count": avg_CN_atom_count["max"]["B_count"],
        "CN_MAX_polyhedron_volume": avg_CN_metrics["max"][
            "volume_of_polyhedron"
        ],
        "CN_MAX_central_atom_to_center_of_mass_dist": avg_CN_metrics["max"][
            "distance_from_avg_point_to_center"
        ],
        "CN_MAX_number_of_edges": avg_CN_metrics["max"]["number_of_edges"],
        "CN_MAX_number_of_faces": avg_CN_metrics["max"]["number_of_faces"],
        "CN_MAX_shortest_distance_to_face": avg_CN_metrics["max"][
            "shortest_distance_to_face"
        ],
        "CN_MAX_shortest_distance_to_edge": avg_CN_metrics["max"][
            "shortest_distance_to_edge"
        ],
        "CN_MAX_volume_of_inscribed_sphere": avg_CN_metrics["max"][
            "volume_of_inscribed_sphere"
        ],
        "CN_MAX_packing_efficiency": avg_CN_metrics["max"][
            "packing_efficiency"
        ],
    }
...
def get_CN_ternary_features(cif: Cif):
    ...
    data = {
        ...
        "CN_MAX_coordination_number": avg_CN_metrics["max"][
            "number_of_vertices"
        ],
